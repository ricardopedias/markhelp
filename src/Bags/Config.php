...
class Config extends Bag
{
    ...
    public function __construct(string $pathRoot)
    {
        ...
        $this->defaults = [
            ...
            'copy.name'           => $this->makeString('Open Source'),
            'copy.url'            => $this->makeString('http://www.ricardopdias.com.br'),
            'created.by'          => $this->makeString('Created by'),
            'creator.name'        => $this->makeString('Ricardo Pereira'),
            'creator.url'         => $this->makeString('http://www.ricardopdias.com.br'),
